          ...
          <div class="card-body flex-column p-5">
              <div class="d-flex align-items-center h-lg-300px p-5 p-lg-15">
                  <div class="d-flex flex-column align-items-start justift-content-center flex-equal me-5">
                     ...
                     <p class="fw-semibold fs-6 fs-lg-5 text-gray-600 mb-5 mb-lg-10">Panduan lengkap untuk menggunakan API kami, termasuk cara penggunaannya dengan berbagai bahasa pemrograman. <br>
                        Untuk memulai, silakan pilih salah satu opsi di bawah ini untuk melihat dokumentasi API yang sesuai dengan kebutuhan Anda.</p>
