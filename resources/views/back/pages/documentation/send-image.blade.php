...
@section('content')
            ...
            <div class="card-body">
                <div class="mb-5">
                    ...
                    <p class="mb-4">
                        ...
                        menyediakan <code>session</code> yang valid, nomor <code>phone</code> tujuan, URL <code>image</code>
                        yang akan dikirim, dan isi <code>message</code> opsional.
                    </p>
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th>URL</th>
                            <td><code>{{ route('api.v1.whatsapp.send-image') }}</code></td>
                        </tr>
                        <tr>
                            <th>Headers</th>
                            <td>
    ...
    "phone" : "62xxxxxxxxxxx",
    "image" : "https://your-url.test/your-image.png",
...
curl -X POST '{{ route('api.v1.whatsapp.send-image') }}' \
  ...
  -d '{
    ...
    "message": "YOUR_MESSAGE_TEXT"
                    ...
                    <span class="token variable">$url</span> = <span class="token string single-quoted-string">'{{ route('api.v1.whatsapp.send-image') }}'</span>;
                    <span class="token variable">$data</span> = [
                        ...
                        <span class="token string single-quoted-string">'image'</span> =&gt; <span class="token string single-quoted-string">'YOUR_IMAGE_URL'</span>,
                    ...
                    <span class="token keyword">fetch</span>(<span class="token string single-quoted-string">'{{ route('api.v1.whatsapp.send-image') }}'</span>, {
...
<span class="token keyword">func</span> <span class="token function">main</span>() {
    url := <span class="token string">"{{ route('api.v1.whatsapp.send-image') }}"</span>
    payload := map[string]string{
        ...
        <span class="token string">"image"</span>:   <span class="token string">"YOUR_IMAGE_URL"</span>,
...
const char* serverUrl = "{{ route('api.v1.whatsapp.send-image') }}";
...
void setup() {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    String payload = "{\"session\":\"YOUR_SESSION_ID\",\"phone\":\"62xxxxxxxxxxx\",\"image\":\"YOUR_IMAGE_URL\",\"message\":\"YOUR_MESSAGE_TEXT\"}";
