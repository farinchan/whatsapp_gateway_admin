...
curl -X POST 'https://api.wa-gateway.torkatatech.com/send-message' \
  ...
  -d '{
    ...
    "text": "YOUR_MESSAGE_TEXT"
                    ...
                    <span class="token python language-python"><span class="token comment"># Contoh Python untuk POST API Send Whatsapp Message</span>
...
<span class="token go language-clike"><span class="token comment">// Contoh Go untuk POST API Send Whatsapp Message</span>
    ...
    fmt.Println(string(body))
                    ...
                    <div class="tab-pane fade" id="iot" role="tabpanel">
                        <div class="highlight"> <button class="highlight-copy btn" data-bs-toggle="tooltip"
                            ...
                            <div class="highlight-code">
                                <pre class="language-clike" tabindex="0"><code class="language-clike">
// Contoh ESP32 (Arduino) untuk POST API Send Whatsapp Message
#include WiFi.h
