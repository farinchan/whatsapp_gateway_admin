...
@include("back/partials/modals/create-campaign/steps/_step-1")
@include("back/partials/modals/create-campaign/steps/_step-2")
@include("back/partials/modals/create-campaign/steps/_step-3")
@include("back/partials/modals/create-campaign/steps/_step-4")
@include("back/partials/modals/create-campaign/steps/_step-5")
                        <!--begin::Actions-->
